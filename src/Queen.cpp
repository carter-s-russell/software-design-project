...
/**
 * @brief The Queen constructor
 *
 * It uses a ternary operator to handle the image of the Queen from its color
...
bool Queen::isValidMove(int curX, int curY, int toX, int toY, bool checkSafety, Board* board) {
